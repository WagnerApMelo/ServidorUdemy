...
namespace ServidorUdemy.Controllers
{
    public class DepartamentsController : Controller
    {
        private readonly ServidorUdemyContext _context;

        public DepartamentsController(ServidorUdemyContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ServidorUdemyContext.Departament'  is null.");
            }
            var departament = await _context.Departament.FindAsync(id);
            if (departament != null)
            {
